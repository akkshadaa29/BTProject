            ...
            <div id="content">
                <div id='mainbar' className='post'>
                    <div className='question-header'>
                        <h1>{post.title}</h1>
                        <div>
                            <Link className='s-btn s-btn__primary'style={{background:'#5fcf80'}}  to='/add/question'>
                                Ask Question
                            </Link>
                        </div>
                    </div>
                                    ...
                                    <div className='answer-layout'>
                                        {/* <div className='vote-cell'>
                                            <div className='vote-container'>
                                                <button
                                                    className='vote-up'
                                                    title='Good answer (click again to undo)'
                                                >
                                                ...
                                                <button
                                                    className='vote-down'
                                                    title='Not a good answer (click again to undo)'
                                                >
                                ...
                                {!auth.loading && auth.isAuthenticated ? <Fragment>
                                    ...
                                    >
                                        <div className='answer-grid'>
                                            ...
                                            <button className='s-btn s-btn__primary' style={{background:'#5fcf80'}} >Post Your Answer</button>
                                        </div>
                                    </form>
                                </Fragment> : <Fragment>
                                    <Link to='/login'>
                                        <button type='button' style={{marginTop: '12px',background:'#5fcf80'}} className="s-btn s-btn__primary" >You need to login to add an answer</button>
                                    </Link>
                                </Fragment>}
                            </div>
                        </div>
