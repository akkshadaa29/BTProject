                ...
                <ul className="d-block p0 m0">
                    ...
                    <li className="s-sidebarwidget--item grid px16">
                        ...
                        <div className="grid--cell">
                            <a href="https://www.cumminscollege.org/student-corner/academic-calendar/"
                               ...
                               data-gps-track="communitybulletin.click({ priority: 1, position: 0 })">Academic Calendar</a>
                        </div>
                    </li>
                    <li className="s-sidebarwidget--item grid px16">
                        {/* <div className="grid--cell1 fl-shrink0">
                        ...
                        <div className="grid--cell">
                            <a href="https://www.cumminscollege.org/student-corner/students-club/"
                               className="js-gps-track"
                               ...
                               data-gps-track="communitybulletin.click({ priority: 1, position: 1 })">Students Club</a>
                        </div>
                    </li>
                    <li className="s-sidebarwidget--item grid px16">
                    <div className="grid--cell">
                            <a href="https://www.cumminscollege.org/scholarship-and-fellowships/"
                               className="js-gps-track"
                               data-ga="[&quot;community bulletin board&quot;,&quot;The Overflow Blog&quot;,&quot;https://stackoverflow.blog/2020/07/14/podcast-252-a-conversation-on-diversity-and-representation/&quot;,null,null]"
                               data-gps-track="communitybulletin.click({ priority: 1, position: 1 })">Scholarships</a>
                        </div>
                    </li>
                    <div
                        className="s-sidebarwidget--header s-sidebarwidget__small-bold-text d:fc-black-900 bb bbw1">
                    ...
                    <li className="s-sidebarwidget--item grid px16">
                        ...
                        <div className="grid--cell">
                            <a href="https://www.cumminscollege.org/category/events/"
                               className="js-gps-track"
                               data-ga="[&quot;community bulletin board&quot;,&quot;The Overflow Blog&quot;,&quot;https://stackoverflow.blog/2020/07/14/podcast-252-a-conversation-on-diversity-and-representation/&quot;,null,null]"
                               data-gps-track="communitybulletin.click({ priority: 1, position: 1 })">Events</a>
                        </div>
